#pragma checksum "C:\ACTUALCSC\CSC-Assignment-2\TheLifeTimeTalents\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1bbc08a75aca9c0cdc250b2e1e0620145ac98ca8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1bbc08a75aca9c0cdc250b2e1e0620145ac98ca8", @"/Views/Home/Index.cshtml")]
    ...
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            EndContext();
            BeginContext(15027, 2566, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "503ea0daee364ec7a58a9452f2e6aada", async() => {
                BeginContext(15083, 2503, true);
                WriteLiteral(@"
    ...
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            EndContext();
            BeginContext(18279, 2797, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "70cbfa518fe94559ab16d775277edee5", async() => {
                BeginContext(18340, 2729, true);
                WriteLiteral(@"
...
<div id=""deleteModal"" class=""modal fade"">
    <div class=""modal-dialog modal-confirm"">
        <div class=""modal-content"">
            ...
            DefineSection("Scripts", async() => {
                BeginContext(22240, 187, true);
                WriteLiteral("\r\n\r\n    <script type=\"text/javascript\" src=\"https://sdk.clarifai.com/js/clarifai-latest.js\"></script>\r\n    <script src=\"https://sdk.amazonaws.com/js/aws-sdk-2.1.24.min.js\"></script>\r\n    ");
                EndContext();
                BeginContext(22427, 51, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8b7611656d174f0b8a11792a896a642a", async() => {
                }
                );
    ...
    ");
        ...
        function fileValidation() {
            ...
            //    reader.onload = function (e) {
            //        console.log(");
                WriteLiteral(@"""This is the start "", imageDetails.clarifaiFaces.length)
            //        imageDetails.b64 = e.target.result;
        ...
        function loadEdit(id) {
            $.ajax({
                ...
                error: function (xhr, textStatus, errorThrown) {
                    if (textStatus == 'timeout') {
                        this.tryCount++;
                        if (this.tryCount <= this.");
                WriteLiteral(@"retryLimit) {
                            //try again
                            $.ajax(this);
                            return;
                        }
                ...
                success: function (data) {
                    ...
                    $('#UpdateTalentReknownInput').val(loadedTal");
                WriteLiteral(@"entReknown);
       ...
       ");
            ...
            $updateTalentHandler.fail(function (jqXHR, textStatus) {
                new noty({
                    ...
                    callback: {
                        onClose: function () {
                            $(`#update");
                WriteLiteral(@"EditSpinner`).addClass(""hidden"");
        ...
        function loadDelete(id) {
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    $(""#deleteR");
                WriteLiteral(@"ec"").text(`Do you really want to delete ${data.name} ?`);
                    $(""#deleteId"").val(id);
                },
                error: function (data) {
                    console.log(data);
        ...
        function deleteRecord() {
            ...
            $.ajax({
                ...
                WriteLiteral(@"nction (data, textStatus, jqXHR) {
                //new noty({
