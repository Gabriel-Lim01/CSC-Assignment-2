    ...
    app.models.predict("a403429f2ddf4b49b307e318f00e528b", {
        ...
        function (res) {
            ...
            if (data == null) {
                ...
                document.getElementById("message").innerHTML = "There is no human in the photo";
            }
            else if (data !== null) {
                ...
                document.getElementById("message").innerHTML = "The number of people in the image is " + imageDetails.clarifaiFaces.length;
            }
            drawBoxes();
            console.log("drawBoxes is done");
        },
        function (err) {
...
function drawBoxes() {
    ...
    for (var i = 0; i < imageDetails.clarifaiFaces.length; i++) {
        ...
        console.log("Filling the faces with emoji next");
